...
is.ensemblgenomes.alive <- function() {
    ...
    "http://rest.ensemblgenomes.org/info/ping?content-type=application/json")
    if (ping$ping == 0)
        stop("The ENSEMBL site seems to be out of order or you might not be 
             connected to the internet. Please try to go to 
