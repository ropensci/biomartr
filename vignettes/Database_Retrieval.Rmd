...
sapply(listDatabases("nt"), download.database, path = "nt")
```

```r
# download the entire NCBI refseq (protein) database
sapply(listDatabases("refseq_protein"), download.database, path = "refseq")
```

```r
# download the entire NCBI PDB database
sapply(listDatabases("pdb"), download.database, path = "pdb")
```
