...
The `getProteome()` function creates a directory named `_ncbi_downloads/proteomes` into which cthe orresponding proteome named `Arabidopsis_thaliana_protein.faa.gz` is downloaded. The `read_proteome()` function enables users to work with the proteome as `data.table` object.
