...
The `getProteome()` function creates a directory named `_ncbi_downloads/proteome` in which
corresponding proteomes are loaded. The `read_proteome()` function allows you to
read the correspondning proteome as `data.table` object.
