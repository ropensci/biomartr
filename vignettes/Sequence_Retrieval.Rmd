...
1            tair_locus            TAIR locus ID(s) plants_mart_23 athaliana_eg_gene
2      tair_locus_model      TAIR locus model ID(s) plants_mart_23 athaliana_eg_gene
3           tair_symbol           TAIR symbol ID(s) plants_mart_23 athaliana_eg_gene
4       with_tair_locus       with TAIR locus ID(s) plants_mart_23 athaliana_eg_gene
5 with_tair_locus_model with TAIR locus model ID(s) plants_mart_23 athaliana_eg_gene
6      with_tair_symbol      with TAIR symbol ID(s) plants_mart_23 athaliana_eg_gene
```

As you can see, we need the filter argument `tair_locus` from `mart` `plants_mart_23` and `dataset` `athaliana_eg_gene`.
...
Source: local data frame [3 x 4]
            ...
            name       description           mart           dataset
1    refseq_mrna    RefSeq mRNA ID plants_mart_23 athaliana_eg_gene
2   refseq_ncrna   RefSeq ncRNA ID plants_mart_23 athaliana_eg_gene
3 refseq_peptide RefSeq protein ID plants_mart_23 athaliana_eg_gene
```
