...
- [1. Perform Meta-Genome Retrieval for Specific Kingdoms of Life](#perform-meta-genome-retrieval)
    ...
    - [1.2 Retrieve Protein Sequences](#retrieve-protein-sequences)
        ...
        - [1.2.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes-1)
    - [1.3 Retrieve CDS Sequences](#retrieve-cds-sequences)
        ...
        - [1.3.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes-2)
    ...
    - [1.6 Retrieve RNA sequences](#retrieve-rna-sequences)
        ...
        - [1.6.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes-3)
...
The `meta.retrieval()` function generates an `*.csv` overview file in the `doc` folder which stores genome version, date, origin, etc information for
all downloaded organisms and can be directly used as Supplementary Data file in publications to increase computational and biological reproducibility in genomics studies.
