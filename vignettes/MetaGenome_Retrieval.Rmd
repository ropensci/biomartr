...
be found at: ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/001/405/GCF_000001405.36_GRCh38.p10/GCF_000001405.36_GRCh38.p10_assembly_stats.txt. 
...
NCBI Genbank stores [metagenome projects](ftp.ncbi.nlm.nih.gov/genomes/genbank/metagenomes/) in addition to species specific genome, proteome or CDS sequences. To retrieve these metagenomes users can perform the following combination of commands:
...
Internally the `listMetaGenomes()` function downloads the assembly_summary.txt file from ftp.ncbi.nlm.nih.gov/genomes/genbank/metagenomes/ to retrieve
