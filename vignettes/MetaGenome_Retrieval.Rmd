...
- [1. Perform Meta-Genome Retrieval for Specific Kingdoms of Life](#perform-meta-genome-retrieval)
    - [1.1 Retrieve Genomic Sequences](#retrieve-genomic-sequences)
        ...
        - [1.1.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes)
    - [1.2 Retrieve Protein Sequences](#retrieve-protein-sequences)
    - [1.3 Retrieve CDS Sequences](#retrieve-cds-sequences)
        - [1.3.1 Retrieval from `NCBI RefSeq`](#retrieval-from-ncbi-refseq-1)
        - [1.3.2 Retrieval from `NCBI Genbank`](#retrieval-from-ncbi-genbank-1)
        - [1.3.3 Retrieval from `ENSEMBL`](#retrieval-from-ensembl-1)
        - [1.3.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes-1)
    ...
    - [1.6 Retrieve RNA sequences](#retrieve-rna-sequences)
        - [1.6.1 Retrieval from `NCBI RefSeq`](#retrieval-from-ncbi-refseq-2)
        - [1.6.2 Retrieval from `NCBI Genbank`](#retrieval-from-ncbi-genbank-2)
        - [1.6.3 Retrieval from `ENSEMBL`](#retrieval-from-ensembl-2)
        - [1.6.4 Retrieval from `ENSEMBLGENOMES`](#retrieval-from-ensemblgenomes-2)
    - [1.7 Retrieve Repeat Masker Repeat Annotation File](#retrieve-repeat-masker-sequences)
        - [1.7.1 Retrieval from `NCBI RefSeq`](#retrieval-from-ncbi-refseq-3)
        - [1.7.2 Retrieval from `NCBI Genbank`](#retrieval-from-ncbi-genbank-3)
...
and investigated. For this purpose, the `meta.retrieval()` and `meta.retrieval.all()` functions allows users to perform straightforward meta-genome retrieval of hundreds of genomes, proteomes, CDS, etc in R.
...
When chosing from which database species shall be retrieved (e.g. `db = "refseq"`),
the `kingdom` argument specification must match the available kingdoms retrieved with e.g. `getKingdoms(db = "refseq")` 
