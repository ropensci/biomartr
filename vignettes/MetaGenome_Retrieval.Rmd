...
meta.retrieval(kingdom = "EnsemblMetazoa", db = "ensemblgenomes", type = "genome", reference = FALSE)
```

Example Fungi:
```{r,eval=FALSE}
# download all fungi genomes
meta.retrieval(kingdom = "EnsemblFungi", db = "ensemblgenomes", type = "genome", reference = FALSE)
```
...
meta.retrieval(kingdom = "EnsemblBacteria", db = "ensemblgenomes", type = "proteome", reference = FALSE)
```
...
meta.retrieval(kingdom = "EnsemblBacteria", db = "ensemblgenomes", type = "cds", reference = FALSE)
```
...
meta.retrieval(kingdom = "EnsemblPlants", db = "ensemblgenomes", type = "gtf", reference = FALSE)
```
...
meta.retrieval(kingdom = "EnsemblBacteria", db = "ensemblgenomes", type = "rna", reference = FALSE)
```
