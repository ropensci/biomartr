...
The following sections will introduce users to the functionality and data retrieval precedures using the [biomaRt](http://www.bioconductor.org/packages/release/bioc/html/biomaRt.html)
