...
Now that you have gene id mapping between refseq ids and tair locus ids (as filter input),
you can select the sequences of genes for which tair locus ids were present within the
proteome provided by refseq.
