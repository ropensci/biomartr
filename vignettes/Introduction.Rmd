...
Users of the [myTAI](http://cran.r-project.org/web/packages/myTAI/index.html) and [orthologr](https://github.com/HajkD/orthologr) packages will find additional functions that will allow them to integrate `biomartr` to any workflow implemented using `myTAI` or `orthologr` and therefore, allows the highest degree of reproducible phylotranscriptomics research from data retrieval to data visualization.
