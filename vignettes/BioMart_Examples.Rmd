...
biological processes on the transcriptome level. However, finding genes sharing a [common evolutionary history](https://github.com/drostlab/myTAI/blob/master/vignettes/Enrichment.Rmd) could reveal how the the biological process might have evolved in the first place.

In this `Use Case` we will combine functional and biological annotation obtained with `biomartr` with enriched genes obtained with [PlotEnrichment()](https://github.com/drostlab/myTAI/blob/master/vignettes/Enrichment.Rmd). 

### Step 1

For the following example we will use the dataset an enrichment analyses found in [PlotEnrichment()](https://github.com/drostlab/myTAI/blob/master/vignettes/Enrichment.Rmd).
